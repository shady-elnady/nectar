    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Countries', to='Language.language', verbose_name='languages')),
            ],
            options={
