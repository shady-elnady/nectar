from rest_framework.serializers import HyperlinkedModelSerializer, Serializer, ListSerializer, ModelSerializer, SerializerMethodField
...
class RecursiveListField(ListSerializer):
...
class CategorySerializer(HyperlinkedModelSerializer):
    ...
    Sub_Categories = RecursiveField(many=True, ordering=('name'))
